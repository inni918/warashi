...
class AsyncLLM(StatelessLLMInterface):
    ...
    async def chat_completion(
        ...
        in_tool_call = False
        # Reasoning fallback state: some "thinking" models only stream their
        ...
        try:
            ...
            async for chunk in stream:
                ...
                # Buffer reasoning tokens from "thinking" models. These fields
            ...
            # Reasoning-only fallback: if the model never produced any visible
